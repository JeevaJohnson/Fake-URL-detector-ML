...
FEATURE_ORDER = [
    'domain_random', 'url_length', 'domain_length', 'path_length',
    'num_dots', 'num_slashes', 'num_digits', 'digit_ratio',
    'num_hyphens', 'num_underscores', 'many_hyphens',
    'has_https', 'has_http', 'num_subdomains', 'has_ip',
    'has_at', 'has_double_slash', 'num_keywords', 'is_shortened',
    'entropy', 'entropy_flag', 'has_login_path', 'path_depth',
    'brand_mismatch', 'legit_path', 'fake_brand',
    'repeated_chars', 'http_login'
]
...
def model_predict(url):
    ...
    X = X[FEATURE_ORDER]   # 👈 ensures correct order
